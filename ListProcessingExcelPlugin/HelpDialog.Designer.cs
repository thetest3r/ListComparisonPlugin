namespace ListProcessingExcelPlugin
{
    ...
    "s to compare your lists:";
            ...
            this.label3.Text = "1. Choose the sheets that you wish to compare by using the sheet dropdowns. If yo" +
    "u do not \r\n    see the sheet that you want to use, click the Refresh button at t" +
    "he bottom of the list.";
            ...
            this.label4.Size = new System.Drawing.Size(429, 52);
            ...
            this.label5.Text = "3. Specify if either sheet has a header row to prevent the plugin from assuming t" +
    "hat it is real \r\n    data as opposed to a header row.";
            // 
            // label6
            // 
